...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "raahildesai8@gmail.com",
    href: "mailto:raahildesai8@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/raahil-m-desai",
    content: "/raahil-desai",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/Raahil-08",
    content: "/raahil-desai",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Raahil Desai </p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Raahil, a Fullstack developer passionate about
